...
void GfxEngine::renderCredits()
{
    ...
    menuString->setString(L"Seby <sebygames@gmail.com>");
    menuString->setPosition((SCREEN_W - menuString->getLocalBounds().width) / 2, 155);
    app->draw(*menuString);
    menuString->setCharacterSize(HELP_TEXT_SIZE);
    menuString->setString(L"Rémi Verschelde (Akien)");
    menuString->setPosition((SCREEN_W - menuString->getLocalBounds().width) / 2, 180);
    app->draw(*menuString);

    menuString->setCharacterSize(HELP_SUBTITLE_SIZE);
    menuString->setString(CREDITS_GRAPHICS[language]);
    menuString->setPosition((SCREEN_W - menuString->getLocalBounds().width) / 2, 215);
    app->draw(*menuString);
    menuString->setCharacterSize(HELP_TEXT_SIZE);
    menuString->setString(L"Suiland (GPLv3+)");
    menuString->setPosition((SCREEN_W - menuString->getLocalBounds().width) / 2, 250);
    app->draw(*menuString);

    menuString->setCharacterSize(HELP_SUBTITLE_SIZE);
    menuString->setString(CREDITS_SOUND[language]);
    menuString->setPosition((SCREEN_W - menuString->getLocalBounds().width) / 2, 285);
    app->draw(*menuString);
    menuString->setCharacterSize(HELP_TEXT_SIZE);
    menuString->setString(L"Obani (CC BY-SA 4.0)");
    menuString->setPosition((SCREEN_W - menuString->getLocalBounds().width) / 2, 320);
    app->draw(*menuString);

    menuString->setCharacterSize(HELP_SUBTITLE_SIZE);
    menuString->setString(CREDITS_MUSIC[language]);
    menuString->setPosition((SCREEN_W - menuString->getLocalBounds().width) / 2, 355);
    app->draw(*menuString);
    menuString->setCharacterSize(HELP_TEXT_SIZE);
    menuString->setString(L"Alex Smith - Crystal Cave (CC BY-SA 3.0)");
    menuString->setPosition((SCREEN_W - menuString->getLocalBounds().width) / 2, 390);
    app->draw(*menuString);
    menuString->setString(L"Bart Kelsey - Contemplation (CC BY-SA 3.0)");
    menuString->setPosition((SCREEN_W - menuString->getLocalBounds().width) / 2, 415);
    app->draw(*menuString);
    menuString->setString(L"Bart Kelsey - Contemplation II (CC BY-SA 3.0)");
    menuString->setPosition((SCREEN_W - menuString->getLocalBounds().width) / 2, 440);
    app->draw(*menuString);
    menuString->setString(L"Przemysław Sikorski - Puzzle tune 1 (CC BY 3.0)");
    menuString->setPosition((SCREEN_W - menuString->getLocalBounds().width) / 2, 465);
    app->draw(*menuString);
